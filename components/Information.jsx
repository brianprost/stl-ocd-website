            ...
            {HomepageLinks.map((HomepageLink) => (
              <li className="flex p-2 m-4" key={HomepageLink.title}>
                {/* <Link href={HomepageLink.link}> */}
                  <a
                    className="block p-6 max-w-sm bg-inherit rounded-lg border border-gray-100 shadow-md transition duration-500 ease-in-out transform hover:-translate-y-1 hover:shadow-lg hover:bg-blue-500"

...
const Article = ({ title, link, description }) => {
  return (
    <a href={link} target="_blank" rel="noopener noreferrer">
      <div className="group box-border h-full rounded-lg border border-blue-100 p-6 transition duration-200 ease-in-out hover:border-blue-500 hover:bg-blue-50 hover:bg-opacity-90">
